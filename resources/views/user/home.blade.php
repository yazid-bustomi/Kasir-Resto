                ...
                <nav class="navbar">
                    ...
                    <div class="navbar-collapse">
                        ...
                        <div class="navbar-extra">
                            <a class="btn-theme btn" style="background-color: #395B64; border-radius: 15px" href="{{route('logout')}}">Logout</a>&nbsp;
                            
                            <button type="button" class="btn-theme btn position-relative"  style="background-color: #395B64; border-radius: 15px;color:white;height:55px;padding-top:10px" >
                            <h2><i class="bx bx-cart" style=""></i></h2>
            ...
            @foreach($produk as $d)
                  <div class="col-lg-3 col-md-6 portfolio-item filter-{{$d->nama_kategori}} " style="background-color:#222831;padding:0px;border-radius:30px;margin-left:30px;" >
                    ...
                    <div class="card-body"  style="color:white;padding:30px;">
                      ...
                      <a class="btn btn-warning" data-toggle="modal" data-target="#exampleModals{{$d->id_produks}}"  title="App 1">Lihat Produk</a>
                      <a  class="btn btn-success" data-toggle="modal" data-target="#exampleModal{{$d->id_produks}}"  title="App 1">Order <i class="bx bx-cart"></i></a>
                    </div>
              ...
              <div class="modal fade" id="exampleModal{{$d->id_produks}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <div class="row" >
                        ...
                        <div class="col-sm-6">
                          <div class="input-group ">
                              ...
                              <input type="number" id="quantity" name="jumlah" class="form-control input-number" value="10" min="1" max="100">
